...
Question.prototype.checkAnswer = function(ans) {
    if(ans === this.correct) {
        console.log('congratulations! it\'s a right answer');
    }else {
...
var answer = parseInt(prompt('Please answer the question correctly!'));
...
var answer = prompt('Please answer the question correctly!');
